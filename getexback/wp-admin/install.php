...
<h1>Already Installed</h1><p>You appear to have already installed WordPress. To reinstall please clear your old database tables first.</p><p class="step"><a href="../wp-login.php" class="button button-large">Log In</a></p></body></html>